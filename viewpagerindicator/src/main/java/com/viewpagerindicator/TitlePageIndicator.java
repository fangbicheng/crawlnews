...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    /**
     * Title text used when no title is provided by the com.fang.crawlnews.adapter.
     */
    ...
    public void setViewPager(ViewPager view) {
        ...
        if (view.getAdapter() == null) {
            throw new IllegalStateException("ViewPager does not have com.fang.crawlnews.adapter instance.");
        }
        mViewPager = view;
